...
const approveProduct = asyncHandler(async (req, res) => {
  ...
  if (product.status !== 'pending_approval') {
    throw ApiError.badRequest(`Cannot approve a product with status '${product.status}'`);
  }
...
const rejectProduct = asyncHandler(async (req, res) => {
  ...
  if (product.status !== 'pending_approval') {
    throw ApiError.badRequest(`Cannot reject a product with status '${product.status}'`);
  }
